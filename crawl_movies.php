...
function crawl_tools()
{
	...
	<div class="wrap">
		<nav class="nav-tab-wrapper">
			<a href="?page=crawl-ophim-tools" class="nav-tab <?php if ($tab === null): ?>nav-tab-active<?php endif; ?>">Thủ
				công</a>
			...
			switch ($tab):
							...
							<div class="inside">
								...
								<div>
									...
									<p>
										...
										<br />
										Mỗi 5 phút:
										<code>*/5 * * * * cd <?php echo CRAWL_OPHIM_PATH; ?> && php -q schedule.php <i style="color:blueviolet"><?php echo get_option(CRAWL_OPHIM_OPTION_SECRET_KEY, ''); ?></i></code>
										<br />
										Mỗi 10 phút:
										<code>*/10 * * * * cd <?php echo CRAWL_OPHIM_PATH; ?> && php -q schedule.php <i style="color:blueviolet"><?php echo get_option(CRAWL_OPHIM_OPTION_SECRET_KEY, ''); ?></i></code>
									</p>
								</div>
							</div>
						</div>
								...
								<div>
									<p>
										...
										<input type="checkbox" class="wppd-ui-toggle" id="crawl_ophim_schedule_enable"
											name="crawl_ophim_schedule_enable" value="" <?php echo (json_decode(file_get_contents(CRAWL_OPHIM_PATH_SCHEDULE_JSON))->enable === true) ? 'checked' : ''; ?>>
									</p>
								</div>
								<div>
									<p>Trạng thái:
				...
				case 'about':
					...
					<div class="crawl_page">
						<div class="postbox">
							<div class="inside">
								Ophim1.CC là website dữ liệu phim miễn phí vĩnh viễn. Cập nhật nhanh, chất lượng cao, ổn định và lâu
								dài. Tốc độ phát cực nhanh với đường truyền băng thông cao, đảm bảo đáp ứng được lượng xem phim trực
								tuyến lớn. Đồng thời giúp nhà phát triển website phim giảm thiểu chi phí của các dịch vụ lưu trữ và
								stream. <br />
								...
								- API được cung cấp miễn phí: <a href="https://ophim1.cc/api-document"
									target="_blank">https://ophim1.cc/api-document</a> <br />
								- Tham gia trao đổi tại: <a href="https://t.me/+QMfjBOtNpkZmNTc1"
									target="_blank">https://t.me/+QMfjBOtNpkZmNTc1</a> <br />
							</div>
						</div>
					</div>
					<?php
							...
							<div class="filter_item">
								...
								foreach ($categoryFromApi as $category) {
									...
									<label><input type="checkbox" class="" name="filter_category[]"
											value="<?php echo $category->name; ?>"> <?php echo $category->name; ?></label>
									<?php
								}
								?>
							</div>
